...
const Transition: FoxgloveMessageSchema = {
  type: "message",
  name: "Transition",
  description: "A transition between two states",
  fields: [
    {
      name: "outcome",
...
const State: FoxgloveMessageSchema = {
  type: "message",
  name: "State",
  ...
  fields: [
    ...
    },
    {
      ...
      description: "Whether the state is a finite state machine",
    },
    {
      name: "current_state",
      defaultValue: -1,
    ...
    {
      name: "transitions",
      type: { type: "nested", schema: Transition },
      array: true,
    ...
    },
    {
      ...
      array: true,
      type: { type: "primitive", name: "string" },
      description: "Outcomes from this state",
    }
  ]
};

const StateMachine: FoxgloveMessageSchema = {
  type: "message",
  name: "StateMachine",
